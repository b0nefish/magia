...
mod tests {
    use magia_disassembler::*;
    mod support;
    use magia_disassembler::AddressRegister::*;
    use magia_disassembler::BitfieldData::*;
    use magia_disassembler::ConditionCode::*;
    use magia_disassembler::DataRegister::*;
    use magia_disassembler::FPConditionCode::*;
    use magia_disassembler::FPFormat::*;
    use magia_disassembler::FloatingRegister::*;
    use magia_disassembler::InstructionExtra::*;
    use magia_disassembler::MemoryIndirection::*;
    use magia_disassembler::Operand::*;
    use magia_disassembler::Operation::*;
    use support::*;
    //  move.b d0,d1
    #[test]
