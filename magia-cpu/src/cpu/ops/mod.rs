...
use super::Exception::*;
use super::{
    Core, Cycles, Result, EXCEPTION_CHK, EXCEPTION_TRAPV, EXCEPTION_TRAP_BASE,
    EXCEPTION_UNIMPLEMENTED_1010, EXCEPTION_UNIMPLEMENTED_1111, EXCEPTION_ZERO_DIVIDE,
};
...
pub fn unimplemented_1010<T: Core>(core: &mut T) -> Result<Cycles> {
    Err(UnimplementedInstruction(
        ir!(core),
        pc!(core).wrapping_sub(2),
        EXCEPTION_UNIMPLEMENTED_1010,
    ))
}
...
macro_rules! add_8_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(8, add_8, $name, $src, dx, $cycles);
    };
}
macro_rules! add_8_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, add_8, $name, dx, $dst, $cycles);
    };
}
macro_rules! add_16_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(16, add_16, $name, $src, dx, $cycles);
    };
}
macro_rules! add_16_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, add_16, $name, dx, $dst, $cycles);
    };
}
macro_rules! add_32_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(32, add_32, $name, $src, dx, $cycles);
    };
}
macro_rules! add_32_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, add_32, $name, dx, $dst, $cycles);
    };
}
...
macro_rules! addi_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, add_8, $name, imm_8, $dst, $cycles);
    };
}
macro_rules! addi_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, add_16, $name, imm_16, $dst, $cycles);
    };
}
macro_rules! addi_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, add_32, $name, imm_32, $dst, $cycles);
    };
}
...
macro_rules! addq_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, add_8, $name, quick, $dst, $cycles);
    };
}
macro_rules! addq_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, add_16, $name, quick, $dst, $cycles);
    };
}
macro_rules! addq_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, add_32, $name, quick, $dst, $cycles);
    };
}
...
macro_rules! and_8_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(8, and_8, $name, $src, dx, $cycles);
    };
}
macro_rules! and_8_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, and_8, $name, dx, $dst, $cycles);
    };
}
macro_rules! and_16_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(16, and_16, $name, $src, dx, $cycles);
    };
}
macro_rules! and_16_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, and_16, $name, dx, $dst, $cycles);
    };
}
macro_rules! and_32_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(32, and_32, $name, $src, dx, $cycles);
    };
}
macro_rules! and_32_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, and_32, $name, dx, $dst, $cycles);
    };
}
...
macro_rules! andi_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, and_8, $name, imm_8, $dst, $cycles);
    };
}
macro_rules! andi_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, and_16, $name, imm_16, $dst, $cycles);
    };
}
macro_rules! andi_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, and_32, $name, imm_32, $dst, $cycles);
    };
}
...
macro_rules! asr_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, asr_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! asr_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, asr_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, asr_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! asr_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, asr_32, $name, $src, $dst, $cycles);
    };
}

macro_rules! asl_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, asl_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! asl_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, asl_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, asl_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! asl_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, asl_32, $name, $src, $dst, $cycles);
    };
}
...
macro_rules! divs {
    ($name:ident, $src:ident, $cycles:expr) => {
        div_op!(divs_16, i16, $name, $src, 158, $cycles);
    };
}
macro_rules! divu {
    ($name:ident, $src:ident, $cycles:expr) => {
        div_op!(divu_16, u16, $name, $src, 140, $cycles);
    };
}
...
macro_rules! eor_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, eor_8, $name, dx, $dst, $cycles);
    };
}
macro_rules! eor_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, eor_16, $name, dx, $dst, $cycles);
    };
}
macro_rules! eor_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, eor_32, $name, dx, $dst, $cycles);
    };
}
...
macro_rules! eori_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, eor_8, $name, imm_8, $dst, $cycles);
    };
}
macro_rules! eori_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, eor_16, $name, imm_16, $dst, $cycles);
    };
}
macro_rules! eori_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, eor_32, $name, imm_32, $dst, $cycles);
    };
}
...
macro_rules! lsr_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, lsr_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! lsr_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, lsr_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, lsr_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! lsr_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, lsr_32, $name, $src, $dst, $cycles);
    };
}

macro_rules! lsl_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, lsl_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! lsl_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, lsl_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, lsl_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! lsl_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, lsl_32, $name, $src, $dst, $cycles);
    };
}
...
macro_rules! movem_16_er {
    ($name:ident, $src:ident, pc, $cycles:expr) => {
        movem_16_er!($name, $src, read_program_word, $cycles);
    };
    ...
    ($name:ident, $src:ident, $cycles:expr) => {
        movem_16_er!($name, $src, read_data_word, $cycles);
    };
...
macro_rules! movem_32_er {
    ($name:ident, $src:ident, pc, $cycles:expr) => {
        movem_32_er!($name, $src, read_program_long, $cycles);
    };
    ...
    ($name:ident, $src:ident, $cycles:expr) => {
        movem_32_er!($name, $src, read_data_long, $cycles);
    };
...
macro_rules! muls {
    ($name:ident, $src:ident, $cycles:expr) => {
        mul_op!(muls_16, i16, $name, $src, $cycles);
    };
}
macro_rules! mulu {
    ($name:ident, $src:ident, $cycles:expr) => {
        mul_op!(mulu_16, u16, $name, $src, $cycles);
    };
}
...
macro_rules! neg_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        negop_8!($name, sub_8, $dst, $cycles);
    };
}
macro_rules! neg_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        negop_16!($name, sub_16, $dst, $cycles);
    };
}
macro_rules! neg_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        negop_32!($name, sub_32, $dst, $cycles);
    };
}
neg_8!(neg_8_dn, dy, 4);
...
macro_rules! negx_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        negop_8!($name, subx_8, $dst, $cycles);
    };
}
macro_rules! negx_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        negop_16!($name, subx_16, $dst, $cycles);
    };
}
macro_rules! negx_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        negop_32!($name, subx_32, $dst, $cycles);
    };
}
...
macro_rules! not_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        notop_8!($name, not_8, $dst, $cycles);
    };
}
macro_rules! not_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        notop_16!($name, not_16, $dst, $cycles);
    };
}
macro_rules! not_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        notop_32!($name, not_32, $dst, $cycles);
    };
}
not_8!(not_8_dn, dy, 4);
...
macro_rules! or_8_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(8, or_8, $name, $src, dx, $cycles);
    };
}
macro_rules! or_8_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, or_8, $name, dx, $dst, $cycles);
    };
}
macro_rules! or_16_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(16, or_16, $name, $src, dx, $cycles);
    };
}
macro_rules! or_16_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, or_16, $name, dx, $dst, $cycles);
    };
}
macro_rules! or_32_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(32, or_32, $name, $src, dx, $cycles);
    };
}
macro_rules! or_32_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, or_32, $name, dx, $dst, $cycles);
    };
}
...
macro_rules! ori_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, or_8, $name, imm_8, $dst, $cycles);
    };
}
macro_rules! ori_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, or_16, $name, imm_16, $dst, $cycles);
    };
}
macro_rules! ori_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, or_32, $name, imm_32, $dst, $cycles);
    };
}
ori_8!(ori_8_dn, dy, 8);
...
macro_rules! ror_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, ror_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! ror_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, ror_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, ror_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! ror_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, ror_32, $name, $src, $dst, $cycles);
    };
}

macro_rules! rol_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, rol_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! rol_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, rol_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, rol_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! rol_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, rol_32, $name, $src, $dst, $cycles);
    };
}
...
macro_rules! roxr_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, roxr_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! roxr_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, roxr_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, roxr_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! roxr_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, roxr_32, $name, $src, $dst, $cycles);
    };
}

macro_rules! roxl_8 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(8, roxl_8, $name, $src, $dst, $cycles);
    };
}
macro_rules! roxl_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, roxl_16, $name, 1, $dst, $cycles);
    };
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(16, roxl_16, $name, $src, $dst, $cycles);
    };
}
macro_rules! roxl_32 {
    ($name:ident, $src:ident, $dst:ident, $cycles:expr) => {
        impl_shift_op!(32, roxl_32, $name, $src, $dst, $cycles);
    };
}
...
macro_rules! sub_8_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(8, sub_8, $name, $src, dx, $cycles);
    };
}
macro_rules! sub_8_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, sub_8, $name, dx, $dst, $cycles);
    };
}
macro_rules! sub_16_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(16, sub_16, $name, $src, dx, $cycles);
    };
}
macro_rules! sub_16_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, sub_16, $name, dx, $dst, $cycles);
    };
}
macro_rules! sub_32_er {
    ($name:ident, $src:ident, $cycles:expr) => {
        impl_op!(32, sub_32, $name, $src, dx, $cycles);
    };
}
macro_rules! sub_32_re {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, sub_32, $name, dx, $dst, $cycles);
    };
}
...
macro_rules! subi_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, sub_8, $name, imm_8, $dst, $cycles);
    };
}
macro_rules! subi_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, sub_16, $name, imm_16, $dst, $cycles);
    };
}
macro_rules! subi_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, sub_32, $name, imm_32, $dst, $cycles);
    };
}
...
macro_rules! subq_8 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(8, sub_8, $name, quick, $dst, $cycles);
    };
}
macro_rules! subq_16 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(16, sub_16, $name, quick, $dst, $cycles);
    };
}
macro_rules! subq_32 {
    ($name:ident, $dst:ident, $cycles:expr) => {
        impl_op!(32, sub_32, $name, quick, $dst, $cycles);
    };
}
